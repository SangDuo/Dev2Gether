 ...
 */
router.get('/board/contest/myPost', function(req, res){
 ...
 */
router.get('/board/contest/myLike', function(req, res){
 ...
 */
router.get('/board/contest', function(req, res){
 ...
 */
router.post('/board/contest', body('title').exists(), body('tag').exists(), body('join_count').exists(), body('content').exists(), function(req, res){
 ...
 */
router.get('/board/contest/:id', function(req, res){
 ...
 */
router.put('/board/contest/:id', body('title').exists(), body('tag').exists(), body('join_count').exists(), body('content').exists(), function(req, res){
 ...
 */
router.delete('/board/contest/:id', function(req, res){
 ...
 */
router.get('/board/contest/:id/like', function(req, res){
 ...
 */
router.get('/board/contest/:id/join', function(req, res){
 ...
 */
router.post('/board/contest/:id/join', body('message').exists(), function(req, res){
 ...
 */
router.get('/board/contest/:id/applications', function(req, res){
 ...
 */
router.post('/board/contest/:id/accept', body('ids').exists(), function(req, res){
 ...
 */
router.post('/board/contest/:id/reject', body('ids').exists(), function(req, res){
