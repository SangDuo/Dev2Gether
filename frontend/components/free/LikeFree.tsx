...
const LikeFree: FunctionComponent<{ board: string }> = ({ board }) => {
  ...
  const fetchPosts = useCallback(() => {
    ...
    axios
      .get('http://163.44.181.194:1212/api/board/free/myLike')
